...
def sepposnegcom(comment_file):
    ...
    ## Sentiment analysis of comments using VADER sentiment analyser
    ...
    if not checkcsv.exists(
        "0.csv"
    ):  # If 0.csv file does not exist, it creates one empty 0.csv file.
